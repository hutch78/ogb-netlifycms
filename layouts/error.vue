<template>
  <main class="main">
    <template v-if="error.statusCode === 404">
      <h1 class="heading mb-2">Page Not Found</h1>
    ...
    <template v-else>
      <h1 class="heading">An error occurred</h1>
      <p class="mb-4">Looks like you've followed a broken link or entered a URL that doesn't exist on this site.</p>
    </template>
    <nuxt-link to="/">
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" class="inline fill-current">
        <path
